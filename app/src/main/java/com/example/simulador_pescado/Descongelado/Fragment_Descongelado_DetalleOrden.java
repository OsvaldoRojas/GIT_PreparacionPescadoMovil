...
public class Fragment_Descongelado_DetalleOrden extends Fragment {
    ...
    public Fragment_Descongelado_DetalleOrden() {
    ...
    public static Fragment_Descongelado_DetalleOrden newInstance(Serializable param1) {
        Fragment_Descongelado_DetalleOrden fragment = new Fragment_Descongelado_DetalleOrden();
