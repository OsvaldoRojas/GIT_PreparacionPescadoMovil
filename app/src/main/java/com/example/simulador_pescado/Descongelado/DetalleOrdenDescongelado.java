...
public class DetalleOrdenDescongelado extends Fragment {
    ...
    public DetalleOrdenDescongelado() {
    ...
    public static DetalleOrdenDescongelado newInstance(Serializable param1) {
        DetalleOrdenDescongelado fragment = new DetalleOrdenDescongelado();
