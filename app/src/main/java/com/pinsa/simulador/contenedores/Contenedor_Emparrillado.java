...
public class Contenedor_Emparrillado extends Fragment {
    ...
    public Contenedor_Emparrillado() {
    }
    ...
    public static Contenedor_Emparrillado newInstance(int param1) {
        Contenedor_Emparrillado fragment = new Contenedor_Emparrillado();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista=inflater.inflate(R.layout.fragment_contenedor_emparrillado, container, false);
    ...
    private void llenarview(ViewPager viewPager) {
        ...
        adatartes2.addfragments(new Fragment_Emparrillado_OM(), getResources().getString(R.string.OM));
