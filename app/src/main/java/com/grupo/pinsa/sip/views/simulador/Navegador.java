...
import com.grupo.pinsa.sip.views.simulador.cocimiento.Fragment_Carga_Carritos;
import com.grupo.pinsa.sip.views.simulador.cocimiento.Fragment_Cocimiento_Plan;
...
import com.grupo.pinsa.sip.views.simulador.contenedores.Contenedor_Cocimiento;
import com.grupo.pinsa.sip.views.simulador.contenedores.Contenedor_Emparrillado;
import com.grupo.pinsa.sip.views.simulador.contenedores.Contenedor_Eviscerado;
import com.grupo.pinsa.sip.views.simulador.contenedores.Contenedor_Lavado;
import com.grupo.pinsa.sip.views.simulador.contenedores.Contenedor_Modulos;
import com.grupo.pinsa.sip.views.simulador.descongelado.Fragment_Descongelado_DetalleEstiba;
...
import com.grupo.pinsa.sip.views.simulador.contenedores.Contenedor_Atemperado;
import com.grupo.pinsa.sip.views.simulador.contenedores.Contenedor_Descongelado;
import com.grupo.pinsa.sip.views.simulador.descongelado.Fragment_Descongelado_Plan;
import com.grupo.pinsa.sip.views.simulador.descongelado.Fragment_Descongelado_SalidaTinas;
import com.grupo.pinsa.sip.views.simulador.emparrillado.Fragment_Emparrillado_Plan;
import com.grupo.pinsa.sip.views.simulador.estatusCocedor.Fragment_Cocida;
import com.grupo.pinsa.sip.views.simulador.estatusCocedor.Fragment_Estatus;
import com.grupo.pinsa.sip.views.simulador.eviscerado.Fragment_Eviscerado_Plan;
import com.grupo.pinsa.sip.views.simulador.lavadoCarros.Fragment_Lavado_Plan;
import com.grupo.pinsa.sip.views.simulador.modulos.Fragment_Detalle_Modulo;
import com.grupo.pinsa.sip.views.simulador.modulos.Fragment_Entrada_Inventario;
import com.grupo.pinsa.sip.views.simulador.modulos.Fragment_Entrada_Manual;
...
import com.grupo.pinsa.sip.views.simulador.preselecion.Fragment_Asigna_Montacargas;
import com.grupo.pinsa.sip.views.simulador.preselecion.Fragment_Asigna_Operador;
...
import com.grupo.pinsa.sip.views.simulador.temperatura.Fragment_Temperatura_Carrito;
import com.grupo.pinsa.sip.views.simulador.temperatura.Fragment_Temperatura_Tina;
import com.grupo.pinsa.sip.views.simulador.temperatura.HomeTemperatura;
...
public class Navegador extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, Fragment_OrdenMantenimiento.OnFragmentInteractionListener,
        ...
        Fragment_Descongelado_SalidaTinas.OnFragmentInteractionListener, com.grupo.pinsa.sip.views.simulador.eviscerado.Fragment_Asigna_Operador.OnFragmentInteractionListener,
        com.grupo.pinsa.sip.views.simulador.emparrillado.Fragment_Asigna_Operador.OnFragmentInteractionListener, Fragment_MovimientoPersonal.OnFragmentInteractionListener,
        ...
        Contenedor_Cocimiento.OnFragmentInteractionListener, com.grupo.pinsa.sip.views.simulador.cocimiento.Fragment_Asigna_Operador.OnFragmentInteractionListener,
        ...
        com.grupo.pinsa.sip.views.simulador.lavadoCarros.Fragment_Asigna_Operador.OnFragmentInteractionListener, Contenedor_Lavado.OnFragmentInteractionListener,
