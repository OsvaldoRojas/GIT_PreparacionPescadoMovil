...
public class Contenedor_Modulos extends Fragment {
    ...
    public Contenedor_Modulos() {
    }

    public static Contenedor_Modulos newInstance(int param1) {
        Contenedor_Modulos fragment = new Contenedor_Modulos();
