...
public class Contenedor_Lavado extends Fragment {
    ...
    public Contenedor_Lavado() {
    }

    public static Contenedor_Lavado newInstance(int param1) {
        Contenedor_Lavado fragment = new Contenedor_Lavado();
    ...
    private void llenarview(ViewPager viewPager) {
        ...
        adatartes2.addfragments(new Fragment_Lavado_Plan(), getResources().getString(R.string.disenoPlan));
