...
public class AdaptadorCarritoModulo extends RecyclerView.Adapter<AdaptadorCarritoModulo.CarritoModuloViewHolder>{

    private List<Carrito> listaCarritos;
    private Fragment pantalla;

    public AdaptadorCarritoModulo(List<Carrito> listaCarritos, Fragment pantalla){
    ...
    public static class CarritoModuloViewHolder extends RecyclerView.ViewHolder{
        ...
        public CarritoModuloViewHolder(View vista, final Fragment pantalla, final List<Carrito> listaCarritos){
            super(vista);
